...
func (d *Router) Start() {
	...
	// FanoutWriter calls Publish() from multiple goroutines, so a given
	// subscriber's diode can be written to concurrently. The default
	// single-writer diode is not safe for that.
